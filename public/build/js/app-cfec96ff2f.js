...
new Vue({
	el: 'body',
	events: {
		'stripe::valid': function stripeValid(valid) {
			this.isValid = valid;
		}
	},
	data: {
	...
	methods: {
		applyDiscount: function applyDiscount(coupon) {
			this.coupon = coupon;
		}
	},
	components: {
...
},{"./components/Form/CreditCard/index.vue":30,"./components/Form/DiscountCoupon/index.vue":31,"./components/Form/Ticket/index.vue":32,"./components/Tables/PriceTable/index.vue":33,"vue":28,"vue-resource":17}],30:[function(require,module,exports){
"use strict";
...
exports.default = {
	...
	methods: {
		...
		stripeGenerateToken: function stripeGenerateToken() {
			this.disabled = true;
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div>\n\t<div class=\"errors col-sm-12\">\n\t\t<div class=\"alert alert-danger\" v-if=\"errors.length > 0\">\n\t\t\t<li>{{errors}}</li>\n\t\t</div>\n\t</div>\n\n\t<input type=\"hidden\" name=\"stripe_token\" v-model=\"token\" id=\"stripe_token\">\n\n\t<div class=\"form-group\">\n\t\t<label for=\"card-number\">Tarjeta de credito</label>\n\t\t<input class=\"form-control\" name=\"card\" type=\"text\" id=\"card\" placeholder=\"**** **** **** {{ placeholder }}\" v-model=\"number\">\n\t</div>\n\n\t<div class=\"form-group row\">\n\t\t<div class=\"col-sm-3\">\n\t\t\t<label for=\"card-expiry-month\">Mes Exp.</label>\n\t\t\t<input class=\"form-control\" type=\"text\" id=\"card-expiry-month\" name=\"month\" placeholder=\"MM\" v-model=\"month\">\n\t\t</div>\n\t\t<div class=\"col-sm-3\">\n\t\t\t<label for=\"card-expiry-year\">Año Exp.</label>\n\t\t\t<input class=\"form-control\" type=\"text\" id=\"card-expiry-year\" name=\"year\" placeholder=\"YYYY\" v-model=\"year\">\n\t\t</div>\n\t\t<div class=\"col-sm-3\">\n\t\t\t<label for=\"card-cvc\">CVC</label>\n\t\t\t<input class=\"form-control\" type=\"text\" id=\"card-cvc\" name=\"cvc\" placeholder=\"CVC\" v-model=\"cvc\">\n\t\t</div>\n\t\t<div class=\"col-sm-3\">\n\t\t\t<label>&nbsp;</label>\n\t\t\t<button type=\"button\" :disabled=\"!!valid\" class=\"btn btn-block {{valid ? 'btn-success' :'btn-info'}} btn-small {{disabled? 'disabled': ''}}\" @click=\"stripeGenerateToken()\">\n\t\t\t\t{{valid ? 'Tarjeta valida' : 'Verificar Tarjeta'}}\n\t\t\t</button>\n\t\t</div>\n\t</div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/boudydegeer/Projects/ulab/events/resources/assets/js/components/Form/CreditCard/index.vue"
  if (!module.hot.data) {
...
},{"vue":28,"vue-hot-reload-api":3}],31:[function(require,module,exports){
var _;
...
module.exports = {
  ...
  methods: {
    validate: function() {
      return this.$http.get('/api/coupons/' + this.code).then(this.success, this.error);
    },
    success: function(response) {
      this.coupon = response.data;
      this.valid = true;
      return this.whenApplied(this.coupon);
    },
    error: function() {
      this.valid = false;
      this.coupon = {
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "<div>\n\t<div class=\"errors col-sm-12\">\n\t\t<div class=\"alert alert-danger\" v-if=\"errors.length > 0\">\n\t\t\t<li>{{errors}}</li>\n\t\t</div>\n\t</div>\n\t<div class=\"form-group\">\n\t\t<!--<label for=\"card-number\">Tarjeta de credito</label>-->\n\t\t<input class=\"form-control\"\n\t\t\t\t\t name=\"coupon\"\n\t\t\t\t\t type=\"text\"\n\t\t\t\t\t id=\"coupon\"\n\t\t\t\t\t placeholder=\"Si tienes un cupón introducelo aqui\"\n\t\t\t\t\t v-model=\"code\"\n\t\t\t\t\t @keyup=\"validate\"\n\t\t>\n\t\t<p class=\"label\"\n\t\t\t v-text=\"coupon.description\"\n\t\t\t :class=\"{'label-primary' : valid, 'label-danger' : !valid}\"\n\t\t>\n\t\t</p>\n\t</div>\n</div>"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/boudydegeer/Projects/ulab/events/resources/assets/js/components/Form/DiscountCoupon/index.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"lodash":1,"vue":28,"vue-hot-reload-api":3}],32:[function(require,module,exports){
module.exports = {
  props: {
    id: null,
    price: {
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "<div class=\"form-group row\">\n\t<div class=\"col-sm-3\">\n\t\t<label for=\"tickets[{{*id}}][amount]\" class=\"control-label\">Amount</label>\n\t\t<input type=\"number\" name=\"tickets[{{*id}}][amount]\" class=\"form-control\" v-model=\"amount\">\n\t</div>\n\n\t<div class=\"col-sm-3\">\n\t\t<label for=\"tickets[{{*id}}][price]\" class=\"control-label\">Price</label>\n\t\t<input type=\"number\" name=\"tickets[{{*id}}][price]\" class=\"form-control\" v-model=\"price\">\n\t</div>\n\n\t<div class=\"col-sm-3\">\n\t\t<label for=\"tickets[{{*id}}][discount]\" class=\"control-label\">Discount</label>\n\t\t<input type=\"number\" name=\"tickets[{{*id}}][discount]\" class=\"form-control\" v-model=\"discount\">\n\t</div>\n\n\t<div class=\"col-sm-3\">\n\t\t<label for=\"tickets[{{*id}}][code]\" class=\"control-label\">Code</label>\n\t\t<input type=\"text\" name=\"tickets[{{*id}}][code]\" class=\"form-control\" v-model=\"code\">\n\t</div>\n</div>"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/boudydegeer/Projects/ulab/events/resources/assets/js/components/Form/Ticket/index.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
module.exports = {
  ...
  filters: {
    ...
    coupon: function(cost) {
      return cost - (this.coupon.discount / 100 * cost);
    },
    discount: function(cost, discount) {
      return -(cost - (cost * (1 - (discount / 100))));
    },
    finalPrice: function(cost, discount) {
      return cost * (1 - (discount / 100));
    },
    vat: function(cost) {
      return cost * (this.taxes / 100);
    }
  }
};

if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "<table class=\"table table-striped\">\n\t<thead>\n\t<tr>\n\t\t<th colspan=\"4\">Concepto</th>\n\t\t<th>Cantidad</th>\n\t\t<th>Precio</th>\n\t</tr>\n\t</thead>\n\t<tfoot>\n\t<tr>\n\t\t<th colspan=\"6\"></th>\n\t</tr>\n\t<tr>\n\t\t<th colspan=\"3\"></th>\n\t\t<th>Subtotal</th>\n\t\t<th></th>\n\t\t<th>{{ ticket.price | price | currency '€' }}</th>\n\t</tr>\n\t<tr v-if=\"coupon.code\">\n\t\t<th colspan=\"3\"></th>\n\t\t<th>Descuento <span class=\"label label-primary\" v-text=\"coupon.description\"></span></th>\n\t\t<th>{{ coupon.discount }}%</th>\n\t\t<th>{{ ticket.price | discount coupon.discount | price | currency '€'}}</th>\n\t</tr>\n\t<tr>\n\t\t<th colspan=\"3\"></th>\n\t\t<th>Iva</th>\n\t\t<th>{{ taxes }}%</th>\n\t\t<th>{{ ticket.price | vat | price | currency '€' }}</th>\n\t</tr>\n\t<tr>\n\t\t<th colspan=\"3\"></th>\n\t\t<th>Total</th>\n\t\t<th></th>\n\t\t<th>{{ ticket.price | finalPrice coupon.discount | price | currency '€'}}</th>\n\t</tr>\n\t</tfoot>\n\n\t<tbody>\n\t<tr>\n\t\t<td colspan=\"4\">{{event.title}}</td>\n\t\t<td>1</td>\n\t\t<td>{{ ticket.price | price | currency '€'}}</td>\n\t</tr>\n\t</tbody>\n</table>"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/boudydegeer/Projects/ulab/events/resources/assets/js/components/Tables/PriceTable/index.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"vue":28,"vue-hot-reload-api":3}]},{},[29]);
